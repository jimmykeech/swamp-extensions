...
// Maintenance surface for @jamesakeech/mongodb-datastore, exposed as model methods so
...
/**
 * Model type `@jamesakeech/mongodb-datastore/maintenance`.
 *
 ...
 */
export const model = {
  type: "@jamesakeech/mongodb-datastore/maintenance",
